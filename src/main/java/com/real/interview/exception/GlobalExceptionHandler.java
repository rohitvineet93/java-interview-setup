...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMovieNotFoundException(
        ...
        return new ResponseEntity<>(body, HttpStatus.NOT_FOUND); // Return 404 Not Found
    }
    ...
    public ResponseEntity<Object> handleGenericRuntimeException(
        ...
        return new ResponseEntity<>(body, HttpStatus.INTERNAL_SERVER_ERROR); // Return 500 Internal Server Error
    }
}